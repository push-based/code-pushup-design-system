 ...
 */
export function visitAngularDecorators(node: ts.Node, visitor: (decorator: ts.Decorator) => void) {
 ...
 */
export function visitAngularDecoratorProperties(decorator: ts.Decorator, visitor: (node: ts.PropertyAssignment) => void) {
