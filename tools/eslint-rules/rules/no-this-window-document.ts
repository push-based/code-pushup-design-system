...
export const rule = eslintRuleFactory(__filename)({
  ...
  meta: {
    ...
    docs: {
      description:
        'Disallow usage of window.document and suggest using DOCUMENT from @angular/common',
    },
    messages: {
      noThisWindowDocument:
        'Avoid accessing the document via the window. Use this._doc declared as: private readonly _doc = inject(DOCUMENT);',
    },
  },
  defaultOptions: [],
  create(context) {
