...
export function mergeConfigs(config: Partial<CoreConfig>, ...configs: Partial<CoreConfig>[]): CoreConfig {
            ...
            Object.entries(obj).reduce((newAcc, [key, value]): CoreConfig => {
                ...
                if (Object.hasOwn(newAcc, key)) {
                    ...
                    if (Array.isArray(newAccProp) && Array.isArray(value)) {
                        ...
                        return { ...newAcc, [key]: mergeConfigs(newAccProp as CoreConfig, value as CoreConfig) };
                    } else {
